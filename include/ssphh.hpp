...
namespace SSPHH {
	...
	class SSPHH_Application : public Viperfish::Widget {
	private:
	...
	public:
		...
		virtual void OnMouseClick(int button, const Viperfish::MouseClickState& mcs) override;
		virtual void OnMouseDoubleClick(int button, const Viperfish::MouseDoubleClickState& mdcs) override;
		virtual void OnMouseDrag(int button, const Viperfish::MouseDragState& mds) override;
